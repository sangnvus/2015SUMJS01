...
(function () {
    ...
    function initiateUpload(e) {
        ...
        var file = $("#post-video-upload").get(0).files[0];
        if (file) {
            var metadata = {
                snippet: {
                    title: $("#post-add-videos-wrapper #video-upload-title").val(),
                    description: $("#post-add-videos-wrapper #video-upload-description").val(),
                    categoryId: 22
                }
            };
    ...
    function resumableUpload(options) {
                    ...
                    xhr.upload.addEventListener(
                      ...
                      function (e) {
                          if (e.lengthComputable) {
                              ...
                              var progressBarWrapper = $("#post-upload-video-progress");
                              progressBarWrapper.removeClass("hidden");

                              var progressBar = $("#post-upload-video-progress .upload-progress");
        ...
        ajax.done(function (response) {
            ...
            $('input[name="uploadedvideo"]').val(videoId);
    ...
    $(function () {
        ...
        $("#post-upload-video-button").click(initiateUpload);
    });
})();