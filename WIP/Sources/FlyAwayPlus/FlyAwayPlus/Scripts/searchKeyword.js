...
function SearchKeyword(id, tag) {
    ...
    function addAccents(input) {
        ...
        retval = retval.replace(/a/ig, "([aĂ Ă¢Ă¤]|ae)");
        retval = retval.replace(/e/ig, "[eĂ¨Ă©ĂªĂ«]");
        retval = retval.replace(/i/ig, "[iĂ®Ă¯]");
        retval = retval.replace(/o/ig, "([oĂ´Ă¶]|oe)");
        retval = retval.replace(/u/ig, "[uĂ¹Ă»Ă¼]");
        retval = retval.replace(/y/ig, "[yĂ¿]");
        retval = retval.replace(/s/ig, "(ss|[sĂŸ])");
        return retval;
    }
